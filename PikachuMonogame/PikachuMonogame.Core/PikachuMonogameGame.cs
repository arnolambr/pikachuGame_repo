...
using PikachuMonogame.Core.Effects;
using PikachuMonogame.Core.Localization;
using PikachuMonogame.Core.Settings;
using PikachuMonogame.ScreenManagers;
using PikachuMonogame.Screens;

namespace PikachuMonogame.Core
{
    /// <summary>
    ...
    /// </remarks>}
    public class PikachuMonogameGame : Game
    {
        ...
        private SettingsManager<PikachuMonogameSettings> settingsManager;

        // Manages leaderboard data for tracking high scores and achievements.
        private SettingsManager<PikachuMonogameLeaderboard> leaderboardManager;
        ...
        public PikachuMonogameGame()
        {
            ...
            settingsManager = new SettingsManager<PikachuMonogameSettings>(storage);
            Services.AddService(typeof(SettingsManager<PikachuMonogameSettings>), settingsManager);

            leaderboardManager = new SettingsManager<PikachuMonogameLeaderboard>(storage);
            Services.AddService(typeof(SettingsManager<PikachuMonogameLeaderboard>), leaderboardManager);
