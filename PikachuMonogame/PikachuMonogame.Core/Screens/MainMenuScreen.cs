...
using PikachuMonogame.Core;
using PikachuMonogame.Core.Effects;
using PikachuMonogame.Core.Inputs;
...
namespace PikachuMonogame.Screens
{
    ...
    internal class MainMenuScreen : MenuScreen
    {
        ...
        private void SetLanguageText()
        {
            ...
            Title = "PikachuMonogame"; // TODO uncomment this if you want it to use Resources.MainMenu; instead
        }
        ...
        public override void LoadContent()
        {
            ...
            settingsManager ??= ScreenManager.Game.Services.GetService<SettingsManager<PikachuMonogameSettings>>();
        ...
        private void UpdateTutorialSteps(GameTime gameTime)
        {
            if (gameTime.TotalGameTime - timeSinceLastMessage > TimeSpan.FromSeconds(3)) // Should the showtime be in settings?
            {
                ...
                if (PikachuMonogameGame.IsMobile)
                {
                    if (tutorialStep > 3)
                    {
                        tutorialStep = -1;
